...
class ImageBeautifyView: UIView {
    ...
    func initData() {
        ...
        currentTypeItem = ImageBeautifyData.data.first
...
extension ImageBeautifyView: UICollectionViewDataSource,
...
extension ImageBeautifyView: ZegoSliderDelegate {
